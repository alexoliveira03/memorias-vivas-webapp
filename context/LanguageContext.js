...
const translations = {
    'pt-BR': {
        ...
        uploadTitle: 'Carregue suas Fotos',
        uploadDesc: 'Envie até 10 fotos de uma vez',
        musicTitle: 'Escolha a Trilha Sonora',
        musicDesc: 'Escolha o som de fundo para seu vídeo',
        generateBtn: 'Gerar Vídeo',
        generateDesc: 'Clique gerar e siga os passos finais para baixar seu vídeo',
    ...
    'en-US': {
        ...
        musicTitle: 'Choose Soundtrack',
        musicDesc: 'Choose the background sound for your video',
        generateBtn: 'Generate Video',
        generateDesc: 'Click generate and follow the final steps to download your video',
